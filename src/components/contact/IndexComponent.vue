  ...
  <section class="relative pb-16">
    <div class="flex z-[2] w-full border-b border-[#a18463]/20 mb-10 sm:mb-20">
      ...
      >
        <div class="mb-4">
          ...
          <ul>
            <li class="text-base xl:text-2xl text-left mb-1">
              Phone :
    ...
    <div class="">
      <div class="p-6 sm:p-8 lg:p-16 flex items-center justify-center flex-col">
        ...
        <p class="text-base xl:text-2xl text-left mb-4">
          Also write us on one of our social handles
        </p>
        <div class="p-3 flex justify-center gap-x-3">
          <div class="">
            <i class="fab fa-instagram fa-2x" aria-hidden="true"></i> <br />
            <small>
              <a href="https://instagram.com/vambleapartments"
                >@vambleapartments</a
              ></small
            >
          </div>
          <div class="">
            ...
            <br />
            <small
              ><a href="https://wa.me/2349064645461">+2349064645461</a>
            </small>
          </div>
          ...
          <div>
            ...
            <br />
            <small>
              <a href="https://twitter.com/vambleapartments"
                >@vambleapartments</a
              ></small
            >
          </div>
