<template>
  <DefaultLayout>
    <template #content>
      <div class="about px-6 sm:px-8 xl:px-16">
        <div class="container py-0 md:py-5">
          <h1 class="font-bold text-3xl mb-5">Terms and Conditions</h1>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Vamble Apartments and Suites, Plot
                790, sector center, Cadastral zone. Jahi. Abuja.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Vamble Apartments and Suites,
                accessible from
                <a
                  href="https://vambleapartments.com"
                  rel="external nofollow noopener"
                  target="_blank"
                  >https://vambleapartments.com</a
                >
              </p>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <p>
                By mail: Plot 790, sector center, Cadastral zone. Jahi. Abuja
              </p>
            </li>
          </ul>
        </div>
